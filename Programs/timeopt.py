...
sys.setrecursionlimit(16000)
                                    ...
                                    #Timing Minimization
def timeopt(N,F,Opsize,Glog,Iparr,Ips,maxIp,parasiticDelay,gate_output_wire_capacitance,Cref,dont_consider_transition_time,x0=20) :
    '''
    I/p to function
    ...
    '''
    print("Info: timeopt(): Calculating Twall")
                                        #Declare Variables
...
#    Fout = (F@ Gsize +  Glog*Opsize)@ X
    ...
    #print(f'Info: timeopt():\nFout as {Fout}\n\nFoutb4x as {(F@ Gsize + (gate_output_wire_capacitance/Cref) + Opsize)}')
